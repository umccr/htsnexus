...
(DX_JOB_ID=job-xxxx client/htsnexus.py -v -s http://localhost:48444/v1/reads -r 11:5005000-5006000 htsnexus_test NA12878 > /dev/null 2> "${TMPDIR}/htsnexus_integration_test.stderr") || true
