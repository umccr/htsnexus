...
output=$(client/htsnexus.py -v -s http://localhost:48444/v1 htsnexus_test NA12878 | $samtools view -c -)
is "$?" "0" "read entire BAM"
is "$output" "39918" "read entire BAM - record count"

output=$(client/htsnexus.py -v -s http://localhost:48444/v1 -r 20 htsnexus_test NA12878 | $samtools view -c -)
...
client/htsnexus.py -s http://localhost:48444/v1 -r 20 htsnexus_test NA12878 > "$BAMFN"
...
client/htsnexus.py -s http://localhost:48444/v1 -r 11:5005000-5006000 htsnexus_test NA12878 > "$BAMFN"
...
client/htsnexus.py -s http://localhost:48444/v1 -r "*" htsnexus_test NA12878 > "$BAMFN"
...
output=$(client/htsnexus.py -s http://localhost:48444/v1 -r 21 htsnexus_test NA12878 | $samtools view -c -)
...
output=$(client/htsnexus.py -s http://localhost:48444/v1 lh3bamsvr EXA00001 | $samtools view -c -)
is "$?" "0" "read entire BAM from Heng Li's bamsvr"
is "$output" "413102" "read entire BAM from Heng Li's bamsvr - record count"

output=$(client/htsnexus.py -s http://localhost:48444/v1 -r 11:10899000-10900000 lh3bamsvr EXA00001 | $samtools view -c -)
...
output=$((client/htsnexus.py -s http://localhost:48444/v1 htsnexus_test NA12878 cram || true) | head -c 4)
...
output=$(client/htsnexus.py -v -s http://localhost:48444/v1 htsnexus_test NA12878 cram | $samtools view -c -)
is "$?" "0" "read entire CRAM"
is "$output" "39918" "read entire CRAM - record count"

output=$(client/htsnexus.py -v -s http://localhost:48444/v1 -r 20 htsnexus_test NA12878 cram | $samtools view -c -)
...
client/htsnexus.py -s http://localhost:48444/v1 -r 20 htsnexus_test NA12878 cram > "$CRAMFN"
...
client/htsnexus.py -s http://localhost:48444/v1 -r 11:5005000-5006000 htsnexus_test NA12878 cram > "$CRAMFN"
...
client/htsnexus.py -s http://localhost:48444/v1 -r "*" htsnexus_test NA12878 cram > "$CRAMFN"
...
output=$(client/htsnexus.py -s http://localhost:48444/v1 -r 21 htsnexus_test NA12878 cram | $samtools view -c -)
...
output=$((client/htsnexus.py -s http://localhost:48444/v1 htsnexus_test 1000genomes VCF || true) | gzip -dc | wc -l)
is "$?" "0" "read entire VCF"
is "$output" "15000" "read entire VCF - line count"

VCFFN="${TMPDIR}/htsnexus_integration_test.vcf"
client/htsnexus.py -v -s http://localhost:48444/v1 -r 22 htsnexus_test 1000genomes VCF | gzip -dc > "$VCFFN"
...
client/htsnexus.py -v -s http://localhost:48444/v1 -r 22:16000000-16300000 htsnexus_test 1000genomes VCF | gzip -dc > "$VCFFN"
...
client/htsnexus.py -v -s http://localhost:48444/v1 -r 20 htsnexus_test 1000genomes VCF | gzip -dc > "$VCFFN"
